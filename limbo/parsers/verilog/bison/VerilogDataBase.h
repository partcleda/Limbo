...
namespace VerilogParser
{
    ...
    struct GeneralName
    {
        ...
        {
            name = n;
            range.low = range.high = std::numeric_limits<int>::min();
        }
        /// @brief constructor
        /// @param n name
    ...
    public:
        ...
        /// @brief read a module declaration with pin name and direction
        ///
        /// module NOR2_X1 ( input a, output b, inout c );
        ///
        /// @param module_name name of a module
        /// @param vPinName array of pins
        /// @param vPinDirection array of pin directions
        // virtual void verilog_module_declaration_cbk(std::string const &module_name, std::vector<GeneralName> const &vPinName, std::vector<GeneralName> const &vPinDirection) = 0;
