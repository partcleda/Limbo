...
struct DefParser
{
	...
	struct DefGrammar : qi::grammar<Iterator, Skipper>
	{
		...
		DefGrammar(DataBaseType &db, ErrorHandler<Iterator> &error_handler) : DefGrammar::base_type(expression), m_db(db)
		{
			...
			expression = // qi::eps >
				*(
					block_other | block_row | block_comp | block_pin | block_net) > lexeme[DEF_NO_CASE("END DESIGN")];
			block_other =
				(lexeme[DEF_NO_CASE("VERSION")] >> text_nc > ";")[boost::phoenix::bind(&DefGrammar::version_cbk, this, _1)] | (lexeme[DEF_NO_CASE("BUSBITCHARS")] >> char_("\"") >> +(char_ - char_("\"")) >> lit("\"") > ";") | (lexeme[DEF_NO_CASE("DIVIDERCHAR")] >> char_("\"") >> (char_ - char_("\"")) >> lit("\"") > ";") | (lexeme[DEF_NO_CASE("DESIGN")] >> text > ";")[boost::phoenix::bind(&DefGrammar::design_cbk, this, _1)] | (lexeme[DEF_NO_CASE("UNITS DISTANCE MICRONS")] >> int_ > ";")[boost::phoenix::bind(&DefGrammar::unit_cbk, this, _1)] | (lexeme[DEF_NO_CASE("DIEAREA")] >> lit("(") >> int_ >> int_ >> lit(")") >> lit("(") >> int_ >> int_ >> lit(")") > ";")[boost::phoenix::bind(&DefGrammar::diearea_cbk, this, _1, _2, _3, _4)];
			block_row =
				(lexeme[DEF_NO_CASE("ROW")] >> text >> text)[boost::phoenix::bind(&DefGrammar::row_cbk_name, this, _1, _2)] >> (int_ >> int_ >> orient)[boost::phoenix::bind(&DefGrammar::row_cbk_position, this, _1, _2, _3)] >> (lexeme[DEF_NO_CASE("DO")] >> int_ >> lexeme[DEF_NO_CASE("BY")] >> int_ >> lexeme[DEF_NO_CASE("STEP")] >> int_ >> int_)[boost::phoenix::bind(&DefGrammar::row_cbk_repeat, this, _1, _2, _3, _4)] > lexeme[";"][boost::phoenix::bind(&DefGrammar::row_cbk, this)];
			block_comp = lexeme[DEF_NO_CASE("COMPONENTS")] >> uint_[boost::phoenix::bind(&DefGrammar::component_cbk_size, this, _1)] > ";" >>
						 *(
							 ...
							 -(
								 ...
								 -(
									 (lit("(") >> int_ >> int_ >> lit(")") >> orient)[boost::phoenix::bind(&DefGrammar::component_cbk_position, this, _1, _2, _3)])) > lexeme[";"][boost::phoenix::bind(&DefGrammar::component_cbk, this)]) >>
			...
			block_pin = lexeme[DEF_NO_CASE("PINS")] >> uint_[boost::phoenix::bind(&DefGrammar::pin_cbk_size, this, _1)] >> ";" >>
						*(
							...
							*(
								lit("+") >>
								((lexeme[DEF_NO_CASE("NET")] >> text)[boost::phoenix::bind(&DefGrammar::pin_cbk_net, this, _1)] | (lexeme[DEF_NO_CASE("DIRECTION")] >> direct)[boost::phoenix::bind(&DefGrammar::pin_cbk_direct, this, _1)] | (status[boost::phoenix::bind(&DefGrammar::pin_cbk_status, this, _1)] >> -((lit("(") >> int_ >> int_ >> lit(")") >> orient)[boost::phoenix::bind(&DefGrammar::pin_cbk_position, this, _1, _2, _3)])) | (lexeme[DEF_NO_CASE("LAYER")] >> text >> lit("(") >> int_ >> int_ >> lit(")") >> lit("(") >> int_ >> int_ >> lit(")"))[boost::phoenix::bind(&DefGrammar::pin_cbk_layer, this, _1, _2, _3, _4, _5)])) > lexeme[";"][boost::phoenix::bind(&DefGrammar::pin_cbk, this)]) >>
			...
			block_net = lexeme[DEF_NO_CASE("NETS")] >> uint_[boost::phoenix::bind(&DefGrammar::net_cbk_size, this, _1)] >> ";" >>
						*(
							...
							+(
								(lit("(") >> text >> text >> lit(")"))[boost::phoenix::bind(&DefGrammar::net_cbk_pin, this, _1, _2)]) > lexeme[";"][boost::phoenix::bind(&DefGrammar::net_cbk, this)]) >>
						lexeme[DEF_NO_CASE("END NETS")];

			text = lexeme[(char_("a-zA-Z_") >> *char_("a-zA-Z_0-9-"))];
			text_nc = lexeme[+char_("a-zA-Z_0-9.-")]; // text no constraints
			orient = lexeme[as_string[DEF_NO_CASE("N")] | as_string[DEF_NO_CASE("S")] | as_string[DEF_NO_CASE("E")] | as_string[DEF_NO_CASE("W")] | as_string[DEF_NO_CASE("FN")] | as_string[DEF_NO_CASE("FS")] | as_string[DEF_NO_CASE("FE")] | as_string[DEF_NO_CASE("FW")]];
	...
	struct SkipperGrammar : qi::grammar<Iterator>
	{
		...
		SkipperGrammar() : SkipperGrammar::base_type(skip)
		{
			...
			skip = ascii::space | ("#" >> *(char_ - eol) >> eol);
		}
	};
	...
	static bool read(DataBaseType &db, const string &defFile)
	{
		...
		cout << "Parsing DEF file in read " << endl;
